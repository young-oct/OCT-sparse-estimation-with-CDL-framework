...
roi = {}
width, height = (20, 10)
roi['artifact'] = [[190, 120, int(width * 1.2), int(height * 1.2)]]
roi['background'] = [[190, 200, int(width * 1.2), int(height * 1.2)]]
roi['homogeneous'] = [[190, 140, int(width * 1.2), int(height * 1.2)],
                      [325, 310, int(width * 1.2), int(height * 1.2)]]
...
if __name__ == '__main__':
    ...
    best = 0.01
    x = processing.make_sparse_representation(s,D, best,w_lmbda,speckle_weight,Ear=True)
