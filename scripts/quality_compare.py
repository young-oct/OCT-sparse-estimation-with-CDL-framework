...
if __name__ == '__main__':
    ...
    ho_s_1 = quality.ROI(*homogeneous[0], s_log)
    ho_s_2 = quality.ROI(*homogeneous[1], s_log)

    ho_x_1 = quality.ROI(*homogeneous[0], x_log)
    ho_x_2 = quality.ROI(*homogeneous[1], x_log)

    ar_s = quality.ROI(*artifact[0], s_log)
    ar_x = quality.ROI(*artifact[0], x_log)
