...
def lmbda_search(s,lmbda,speckle_weight):
    ...
    return (snrh2b,conh2b,conh1h2,gcnrh1a,gcnrh2b,gcnrh12,gcnrh2a)
...
def value_plot(lmbda,value):
    ...
    snrh2b,conh2b,conh1h2,gcnrh1a,gcnrh2b,gcnrh12,gcnrh2a = [],[],[],[],[],[],[]
    ...
    ax[1].plot(lmbda, gcnrh2a, color='purple',label = r'${gCNR_{{H_2}/{A}}}$')
    ax[1].axhline(reference[5],color='purple',linestyle = '--')

    ax[1].set_ylabel(r'${gCNR}$')
    ax[1].set_xlabel('𝜆 ')
    ax[1].legend()
